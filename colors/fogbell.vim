...
call <sid>hi('MatchParen', s:voidBlack, s:voidSteel, 'none')
...
call <sid>hi('NonText', s:voidGray1, s:voidBlack, 'none')
...
call <sid>hi('SpecialKey', s:voidGray1, s:voidBlack, 'none')
